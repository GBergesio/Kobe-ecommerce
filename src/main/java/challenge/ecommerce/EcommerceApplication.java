...
public class EcommerceApplication {
	...
	public CommandLineRunner initData(ProductRepository productRepository, ClientRepository clientRepository) {
		return (args) -> {
			...
			Product product48 = new Product("Dragon Ball - Vegeta","todo decoraciones, ideal para regalo o decoracion de la casa","https://static.bookscovers.es/imagenesP/3665361/366536103067.JPG","https://i.ibb.co/b11L5yt/YVDKLIO6-LVBB5-BF2-CN5-DYPEYGA.jpg",  (short) 13,999.0,"Marvel",  Category.BAZARANDTOYSHOP , "Llavero para que personalices tu llaves");
			productRepository.save(product48);
			Product product49 = new Product("Dragon Ball - Vegeta ","todo decoraciones, ideal para regalo o decoracion de la casa","https://i.ibb.co/5FRXn6V/41m-Wzi-NS-XL.jpg","https://i.ibb.co/b11L5yt/YVDKLIO6-LVBB5-BF2-CN5-DYPEYGA.jpg",  (short) 13,999.0,"Marvel",  Category.BAZARANDTOYSHOP , "Llavero para que personalices tu llaves");
			productRepository.save(product49);
			Product product50 = new Product("Dragon Ball - Goku","todo decoraciones, ideal para regalo o decoracion de la casa","https://i.pinimg.com/736x/9d/43/48/9d4348e22ec30a4c65c22979bde96ee7.jpg","https://i.ibb.co/PDWJm09/VNb-J8f-Gm-400x400.jpg",  (short) 13,999.0,"Marvel",  Category.BAZARANDTOYSHOP , "Llavero para que personalices tu llavess");
			productRepository.save(product50);
			Product product51 = new Product("Dragon Ball - Vegeta ","todo decoraciones, ideal para regalo o decoracion de la casa","https://cdn.shopify.com/s/files/1/0413/4253/3797/products/HTB1X5v3A41YBuNjy1zcq6zNcXXaz.jpg?v=1603124755","https://i.ibb.co/b11L5yt/YVDKLIO6-LVBB5-BF2-CN5-DYPEYGA.jpg",  (short) 13,999.0,"Marvel",  Category.BAZARANDTOYSHOP , "Llavero para que personalices tu llaves");
			productRepository.save(product51);
			Product product52 = new Product("Marvel Series - llavero ","todo decoraciones, ideal para regalo o decoracion de la casa","https://i.ibb.co/1Jgcr7C/image-63bbec126c7248f5b39943aa43002507.jpg","https://i.ibb.co/b11L5yt/YVDKLIO6-LVBB5-BF2-CN5-DYPEYGA.jpg",  (short) 13,999.0,"Marvel",  Category.BAZARANDTOYSHOP , "Llavero para que personalices tu llaves");
			productRepository.save(product52);
			Product product53= new Product("Marvel Series - llavero ","todo decoraciones, ideal para regalo o decoracion de la casa","https://i.ibb.co/k6jqYwS/9113292-0.png","https://i.ibb.co/b11L5yt/YVDKLIO6-LVBB5-BF2-CN5-DYPEYGA.jpg",  (short) 13,999.0,"Marvel",  Category.BAZARANDTOYSHOP , "Llavero para que personalices tu llaves");
			productRepository.save(product53);
			Product product54 = new Product("Marvel Series - llavero ","todo decoraciones, ideal para regalo o decoracion de la casa","https://i.ibb.co/k6jqYwS/9113292-0.png","https://i.ibb.co/b11L5yt/YVDKLIO6-LVBB5-BF2-CN5-DYPEYGA.jpg",  (short) 13,999.0,"Marvel",  Category.BAZARANDTOYSHOP , "Llavero para que personalices tu llaves");
			productRepository.save(product54);
			Product product55 = new Product("Marvel Series -llavero ","todo decoraciones, ideal para regalo o decoracion de la casa","https://i.ibb.co/k6jqYwS/9113292-0.png","https://i.ibb.co/b11L5yt/YVDKLIO6-LVBB5-BF2-CN5-DYPEYGA.jpg",  (short) 13,999.0,"Marvel",  Category.BAZARANDTOYSHOP , "Llavero para que personalices tu llaves");
			productRepository.save(product55);
			Product product56 = new Product("Marvel Series - llavero ","todo decoraciones, ideal para regalo o decoracion de la casa","https://i.ibb.co/k6jqYwS/9113292-0.png","https://i.ibb.co/b11L5yt/YVDKLIO6-LVBB5-BF2-CN5-DYPEYGA.jpg",  (short) 13,999.0,"Marvel",  Category.BAZARANDTOYSHOP, "Llavero para que personalices tu llaves");
			productRepository.save(product56);
			Product product57 = new Product("Marvel Series - Saiyan Blue ","Funda edición Dragon Ball para Iphone","https://i.ibb.co/k6jqYwS/9113292-0.png","https://i.ibb.co/b11L5yt/YVDKLIO6-LVBB5-BF2-CN5-DYPEYGA.jpg",  (short) 13,6999.0,"Marvel",  Category.BAZARANDTOYSHOP , "Fundas de Iphone Personalizados");
