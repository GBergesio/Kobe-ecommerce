	...
	public CommandLineRunner initData(ProductRepository productRepository, ClientRepository clientRepository) {
		return (args) -> {
			...
			Product product323 = new Product("One Piece - Sanji",
					"todo decoraciones, ideal para regalo o decoracion de la casa",
					"https://i.ibb.co/6yVwvN6/bffc74d65425d4888e46a09c0838d57b.jpg",
					"https://i.ibb.co/Ydq5VZJ/46d976910b261a600fa78ca382d193eee9de37cf-00.jpg",
					(short) 14, 999.0, "One Piece",
					Category.BAZARANDTOYSHOP, "Mouse Pad");
			productRepository.save(product323);
			Product product324 = new Product("One Piece - Sanji",
					"todo decoraciones, ideal para regalo o decoracion de la casa",
					"https://i.ibb.co/J5BXcdP/one-piece-sanji-rgb-gamer-mouse-pad-pc-gaming-mousepad-large-computer-desk-mat-xl-size-1200x1200.jpg",
					"https://i.ibb.co/Ydq5VZJ/46d976910b261a600fa78ca382d193eee9de37cf-00.jpg",
					(short) 14, 999.0, "One Piece",
					Category.BAZARANDTOYSHOP, "Mouse Pad");
			productRepository.save(product324);
			Product product325 = new Product("One Piece - Franky",
					"todo decoraciones, ideal para regalo o decoracion de la casa",
					"https://i.ibb.co/3dLYxKd/images-q-tbn-ANd9-Gc-SUu-Bs-Ztk-OZKXZNp-M7-Mamx0o-C44s-UHJj-Oixr-BYAkn-YA-9-9-WD-I6-EE-SJT-w-24-Ix-C.jpg",
					"https://i.ibb.co/0KDwRyK/bd25d6710d38539099ba3171cefbeaf4.jpg",
					(short) 14, 999.0, "One Piece",
					Category.BAZARANDTOYSHOP, "Mouse Pad");
			productRepository.save(product325);
			Product product326 = new Product("One Piece - Franky",
					"todo decoraciones, ideal para regalo o decoracion de la casa",
					"https://i.ibb.co/vcVMHfV/Franky-Mouse-Mat-One-Piece-Anime-Accessories-Gear-Wanta-6-650x.jpg",
					"https://i.ibb.co/0KDwRyK/bd25d6710d38539099ba3171cefbeaf4.jpg",
					(short) 14, 999.0, "One Piece",
					Category.BAZARANDTOYSHOP, "Mouse Pad");
			productRepository.save(product326);
			Product product327 = new Product("One Piece - Luffy",
					"todo decoraciones, ideal para regalo o decoracion de la casa",
					"https://i.ibb.co/FgtJz6t/D-NQ-NP-852211-MLA45537708773-042021-O.webp",
					"https://i.ibb.co/6gkwCs2/bf1d317827ae2e9592a260db9eda9471eedfa451-00.jpg",
					(short) 14, 999.0, "One Piece",
					Category.BAZARANDTOYSHOP, "Mouse Pad");
			productRepository.save(product327);
			Product product328 = new Product("One Piece - Luffy",
					"todo decoraciones, ideal para regalo o decoracion de la casa",
					"https://i.ibb.co/5RNd0ns/One-Piece-alfombrilla-de-rat-n-de-Anime-3-D-para-Gaming-con-reposamu-ecas-de-Gel.jpg",
					"https://i.ibb.co/6gkwCs2/bf1d317827ae2e9592a260db9eda9471eedfa451-00.jpg",
					(short) 14, 999.0, "One Piece",
					Category.BAZARANDTOYSHOP, "Mouse Pad");
			productRepository.save(product328);
			Product product329 = new Product("One Piece - Zoro",
					"todo decoraciones, ideal para regalo o decoracion de la casa",
					"https://i.ibb.co/hFkmdx1/61-ZWVPPICr-S-AC-SY355.jpg",
					"https://i.ibb.co/b3Qsny2/fanart-zoro-one-piece.jpg",
					(short) 14, 999.0, "One Piece",
					Category.BAZARANDTOYSHOP, "Mouse Pad");
			productRepository.save(product329);
			Product product330 = new Product("One Piece - Zoro",
					"todo decoraciones, ideal para regalo o decoracion de la casa",
					"https://i.ibb.co/HG8H2Vp/mouse-pad-extra-largo-xxl-80cm-x-30cm-diseno-one-piece-zoro-3mm.jpg",
					"https://i.ibb.co/b3Qsny2/fanart-zoro-one-piece.jpg",
					(short) 14, 999.0, "One Piece",
					Category.BAZARANDTOYSHOP, "Mouse Pad");
			productRepository.save(product330);
			//funda
			Product product331 = new Product("One Piece - Zoro",
					"Funda edición One Piece para Iphone",
					"https://i.ibb.co/98dBRBS/15704590-0.png",
					"https://i.ibb.co/b3Qsny2/fanart-zoro-one-piece.jpg",
					(short) 14, 999.0, "One Piece",
					Category.ACCESSORIES, "Iphone Cases");
			productRepository.save(product331);
			Product product332 = new Product("One Piece - Zoro",
					"Funda edición One Piece para Iphone",
					"https://i.ibb.co/tb03HRd/funda-one-piece-zoro-1200x1200.jpg",
					"https://i.ibb.co/b3Qsny2/fanart-zoro-one-piece.jpg",
					(short) 14, 999.0, "One Piece",
					Category.ACCESSORIES, "Iphone Cases");
			productRepository.save(product332);
			Product product333 = new Product("One Piece - Luffy",
					"Funda edición One Piece para Iphone",
					"https://i.ibb.co/Lr0mkhz/61-GUMPYxge-L-AC-SS450.jpg",
					"https://i.ibb.co/6gkwCs2/bf1d317827ae2e9592a260db9eda9471eedfa451-00.jpg",
					(short) 14, 999.0, "One Piece",
					Category.ACCESSORIES, "Iphone Cases");
			productRepository.save(product333);
			Product product334 = new Product("One Piece - Luffy",
					"Funda edición One Piece para Iphone",
					"https://i.ibb.co/HCbS2qQ/16731020-0.png",
					"https://i.ibb.co/6gkwCs2/bf1d317827ae2e9592a260db9eda9471eedfa451-00.jpg",
					(short) 14, 999.0, "One Piece",
					Category.ACCESSORIES, "Iphone Cases");
			productRepository.save(product334);
			Product product335 = new Product("One Piece - Franky",
					"Funda edición One Piece para Iphone",
					"https://i.ibb.co/WcN3d3L/15284363-0.png",
					"https://i.ibb.co/0KDwRyK/bd25d6710d38539099ba3171cefbeaf4.jpg",
					(short) 14, 999.0, "One Piece",
					Category.ACCESSORIES, "Iphone Cases");
			productRepository.save(product335);
			Product product336= new Product("One Piece - Franky",
					"Funda edición One Piece para Iphone",
					"https://i.ibb.co/pLHq9sh/Funda-de-tel-fono-Anime-Luffy-One-Piece-para-Apple-i-Phone-11-13-12-Pro-XS-jpg-640x640.jpg",
					"https://i.ibb.co/0KDwRyK/bd25d6710d38539099ba3171cefbeaf4.jpg",
					(short) 14,999.0,"One Piece",
					Category.ACCESSORIES, "Iphone Cases");
			productRepository.save(product336);
			Product product337= new Product("One Piece - Sanji",
					"Funda edición One Piece para Iphone",
					"https://i.ibb.co/6BknBHs/funda-one-piece-sanji-1200x1200.jpg",
					"https://i.ibb.co/Ydq5VZJ/46d976910b261a600fa78ca382d193eee9de37cf-00.jpg",
					(short) 14,999.0,"One Piece",
					Category.ACCESSORIES, "Iphone Cases");
			productRepository.save(product337);
			Product product338= new Product("One Piece - Sanji",
					"Funda edición One Piece para Iphone",
					"https://i.ibb.co/9yHGdFS/10882906-0.png",
					"https://i.ibb.co/Ydq5VZJ/46d976910b261a600fa78ca382d193eee9de37cf-00.jpg",
					(short) 14,999.0,"One Piece",
					Category.ACCESSORIES, "Iphone Cases");
			productRepository.save(product338);
